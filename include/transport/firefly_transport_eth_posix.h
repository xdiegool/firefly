 ...
 * ethernet posix specific data and open an ethernet socket bound to the
 ...
 *
 * If no such connection exists the #firefly_on_conn_recv_eth_posix_f will be
 * called, if it is NULL the data will be discarded.
 *
 * This function is blocking.
 *
 * @param llp The Link Layer Port to read data from.
 * @param tv The time to wait for new data before aborting.
 * @see firefly_on_conn_recv_eth_posix_f
 */
